...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-start gap-1 rounded-full border border-border/80 bg-background/80 p-1 text-muted-foreground shadow-sm backdrop-blur",
      className
    )}
    {...props}
  />
